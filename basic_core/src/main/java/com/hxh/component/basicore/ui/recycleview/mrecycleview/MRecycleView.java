...
import com.hxh.component.basicore.ui.recycleview.itemdecoration.RecycleViewItemDecoration;
...
public class MRecycleView<D> extends FrameLayout{
    ...
    {
        recycleview.addItemDecoration(new RecycleViewItemDecoration(getContext(),20));
        return this;
    }
    ...
    private class AdaterDataSourceImpl<P> implements IDataSourceView
    {
        ...
        @Override
        public void setEmpty(EmptyViewConfig config) {
            recycleview.setVisibility(GONE);
            empty_view.setEmptyViewConfig(config);
            empty_view.show();
            closeRefresh();
        }
