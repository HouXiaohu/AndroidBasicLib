...
import com.hxh.component.basicore.util.aspj.annotationenum.PermissionDenyEnum;
...
public class PermissionActivityActivity extends AppCompatActivity {
    ...
    private void showMissingPermissionDialog() {
        ...
        String msg = "当前应用缺少必要权限。请点击\"设置\"-\"权限\"打开所需权限"+ (mPermissionDenyEnum == PermissionDenyEnum.FINSH?"":",如果您忽略了，那么会导致某些功能无法使用！");
        Utils.DialogUtils.showDefaulStyleDialog(msg, "忽略", "去设置", new OnItemClickListener() {
            @Override
