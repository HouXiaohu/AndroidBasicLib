...
public class AppCompartAutoLayoutFragment extends Fragment implements ISupportFragment
{
    ...
    public void start(final ISupportFragment toFragment,long milis) {
    ...
    public void popTo(final Class<?> targetFragmentClass,final boolean includeTargetFragment,long mi) {
        getView().postDelayed(new Runnable() {
            @Override
            public void run() {
                mDelegate.popTo(targetFragmentClass, includeTargetFragment);
