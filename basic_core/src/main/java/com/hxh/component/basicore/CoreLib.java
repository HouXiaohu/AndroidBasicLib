...
public class CoreLib {
    ...
    public static class Builder
    {
        ...
        /**
         * 是否开启U盟统计
         * @param sessionStatisticsEnable   是否开启Session统计（启动次数，单词使用时长）
         * @return
         */
        public Builder setEnableUMengStatistics(boolean sessionStatisticsEnable)
        {
            this.isEnableUMengUserrecording = sessionStatisticsEnable;
        ...
        public CoreLib build() {
            ...
            core.setLogEnable(!Utils.Text.isEmpty(logtag));
