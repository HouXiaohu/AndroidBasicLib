...
import com.hxh.component.basicore.component.net.RequestInterceptor;
import com.hxh.component.basicore.component.net.cookie.CookiesManager;
import com.hxh.component.basicore.component.net.factory.FastJsonConverterFactory;
...
public class RetrofitBaseApiImpl implements IRetrofitBaseApi {
    ...
    private static class SingletonHolder {
        private static final RetrofitBaseApiImpl INSTANCE = new RetrofitBaseApiImpl();
    }

    private RetrofitBaseApiImpl() {
    }

    public static final RetrofitBaseApiImpl getInstance() {
     ...
     * @return
     */
    public RetrofitBaseApiImpl setConvertFactory(int factorytype) {
    ...
    public Retrofit createRetrofit(String baseUrl, String convertFactoryname, NetProvider provider) {
    ...
    public String getConvertFactoryName(Converter.Factory factory) {
        if (null == factory) {
            return "";
        }
     ...
     */
    public OkHttpClient getOkHttpClient(String baseUrl, NetProvider provider) {
        ...
        {
            builder.addInterceptor(new HttpInterceptor().buildErrorRetryInterceptor(provider.getErrorRetryCount()));
        }
        ...
        if (CoreLib.getInstance().isLogEnable()) {
            ...
            if (null != provider.getConfigLogTnterceptor()) {
                ...
                if ("".equals(logtag) || null == logtag)
                    builder.addInterceptor(new HttpInterceptor().buildLogInterceptor());
                else new HttpInterceptor().buildLogInterceptor();
            }
        }
