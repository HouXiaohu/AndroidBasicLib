package com.hxh.component.basicore.ui.recycleview.layoutmanager;
...
/**
 * 当你在ScroolView中使用RecycleView的时候，有时会导致RecycleView无法显示，那么你就用此LayoutManger
 */
...
public class FullLinearLayoutManager extends LinearLayoutManager {
    ...
    @SuppressWarnings("UnusedDeclaration")
    public FullLinearLayoutManager(RecyclerView view) {
    ...
    @SuppressWarnings("UnusedDeclaration")
    public FullLinearLayoutManager(RecyclerView view, int orientation, boolean reverseLayout) {
